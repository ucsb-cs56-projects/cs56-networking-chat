...
public class Server{
    ...
    private User peng, andro, philp, bill, steve, orange, max, bryce;
    ...
    private String s0 = "------------------------------------------SERVER USAGE-----------------------------------------------\n";
    private String s1 = "             We currently have a FAKE database with only the users listed below:         \n";
    private String s2 = "                           \n";
    private String s3 = "                     Username: Andro Stotts     Nickname: andro    Password: abc123      \n";
    private String s4 = "                     Username: Phillip Conrad   Nickname: phill    Password: 9876543     \n";
    private String s5 = "                     Username: Steve Jobs       Nickname: steven   Password: 2as134      \n";
    private String s6 = "                     Username: Bill Gates       Nickname: billy    Password: idu?e3e     \n";
    private String s7 = "                     Username: Orange Juice     Nickname: oj       Password: orangejuice \n";
    private String s8 = "                     Username: Max Hinson       Nickname: max      Password: password    \n";
    private String s9 = "                     Username: Bryce Filler     Nickname: bry      Password: bryce       \n";
    private String s10 = "-----------------------------------------------------------------------------------------------------\n";
    private String s11 = "      NOTE: PLEASE USE ABOVE ACCOUNTS TO LOGIN OUR CLIENT APPLICATION FOR TESTING PURPOSES           \n";
    private String s12 = "-----------------------------------------------------------------------------------------------------\n";
    ...
    private Server(){
        ...
        peng = new User("Peng Wang", "peng", "123abc");
        andro = new User("Andro Stotts", "andro", "abc123");
        philp = new User("Phillip Conrad", "phill", "9876543");
        bill = new User("Bill Gates", "billy", "idu?e3e");
        steve = new User("Steve Jobs", "steven", "2as134");
        orange = new User("Orange Juice ", "oj", "orangejuice");
        max = new User("Max Hinson", "max", "password");
        bryce = new User("Bryce Filler", "bry", "bryce");
        ...
        public void run() {
            try{
                ...
                if(isAuthorized){
                    ...
                    if(this.getNickname() == "andro")
                        availableUsers.remove(andro);
                    if(this.getNickname() == "phill")
                        availableUsers.remove(philp);
                    if(this.getNickname() == "billy")
                        availableUsers.remove(bill);
                    if(this.getNickname() == "steven")
                        availableUsers.remove(steve);
                    if(this.getNickname() == "oj")
                        availableUsers.remove(orange);
                    if(this.getNickname() == "bry")
                        availableUsers.remove(bryce);
                    for (User u : availableUsers) {
                        controller.displayMsg("                     Username:" + u.getName() + " Nickname:" +  u.getNickname() + "   Password:" +u.getPassword() + " \n");
